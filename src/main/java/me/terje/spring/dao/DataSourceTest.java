...
public class DataSourceTest extends HikariConfig{
    ...
    public DataSourceTransactionManager transactionManager(
            @Qualifier("data_source_test") DataSource dataSource) {
        return new DataSourceTransactionManager(dataSource);
    }

    @Bean(name = "sqlSessionFactory")
    public SqlSessionFactory sqlSessionFactory(@Qualifier("data_source_test") DataSource dataSource)throws Exception {
